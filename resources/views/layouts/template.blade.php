...
<head>
    ...
    <title>Dashboard Wes Makmur</title>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="{{ route('beranda') }}"><i
                                        class="fas fa-home fa-sm fa-fw mr-2 text-gray-400"></i> Beranda</a>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Anhar 2023</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form action="{{ route('logout') }}" method="post">
                        @csrf
                        <button type="submit" class="btn btn-primary" href="{{ route('logout') }}">Logout</button>
                    </form>
